...
void pwmEnable()
{
	...
	TIM8->CCMR2 = TIM_CCMR2_OC4M_1 | TIM_CCMR2_OC4M_0 | TIM_CCMR2_OC3M_2
		| TIM_CCMR2_OC3M_1 | TIM_CCMR2_OC3PE;
	TIM8->CCER = TIM_CCER_CC4E | TIM_CCER_CC3NE | TIM_CCER_CC3E | TIM_CCER_CC2NE
	...
	MODIFY_REG(GPIOC->AFR[0], (15UL << 24) | (15UL << 28),
			(3UL << 24) | (3UL << 28));
	MODIFY_REG(GPIOC->AFR[1], (15UL << 0), (3UL << 0));
...
void pwmDisable()
{
	...
	MODIFY_REG(GPIOB->MODER, GPIO_MODER_MODER0 | GPIO_MODER_MODER1, 0);
